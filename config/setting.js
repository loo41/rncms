module.exports = {
  ...
  admin: {
    router: ['/login', '/userList', 
      ...
      '/getArticleContent', '/upload', '/manage/upload', '/users', '/baseData'],
    updateRouter: false,               /** 切记设置为true后保存重启完成后设置回flase  */
    alias: {},
    baseURL: 'http://127.0.0.1:' + (process.env.PORT || 8000), // http://127.0.0.1:' + (process.env.PORT || 8055)
    github: 'https://github.com/loo41/rncms',
    clientUrl: 'http://wine.tianchenyong.top' // http://wine-admin.tianchenyong.top
  },
  server: {
